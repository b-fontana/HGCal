#ifndef HGCalMaskVisualProd_h
#define HGCalMaskVisualProd_h
...
// class declaration
//
class HGCalMaskVisualProd : public edm::stream::EDProducer<> {
public:
  explicit HGCalMaskVisualProd(const edm::ParameterSet&);
  ~HGCalMaskVisualProd();
