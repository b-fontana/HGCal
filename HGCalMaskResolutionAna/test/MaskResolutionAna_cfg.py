...
#Inner radius: indir1 = "/eos/cms/store/cmst3/group/hgcal/CMG_studies/Production/FlatRandomEGunProducer_bfontana_20190531/RECO/" 
#Outer radius: 
indir2 = "/eos/cms/store/cmst3/group/hgcal/CMG_studies/Production/FlatRandomEGunProducer_bfontana_outer_20190605/RECO/" 
fNames = ["file:" + it for it in glob.glob(os.path.join(indir2,"*.root"))][F.fidx]
