#ifndef HGCalRecHitsMaskStudies_h
#define HGCalRecHitsMaskStudies_h
...
//user include files
#include "UserCode/HGCalRecHitsMaskStudies/interface/FileUtils.h"

//
// class declaration
//
class HGCalRecHitsMaskStudies : public edm::stream::EDProducer<> {
public:
  explicit HGCalRecHitsMaskStudies(const edm::ParameterSet&);
  ~HGCalRecHitsMaskStudies();
...
#endif //HGCalRecHitsMaskStudies_h
