...
static constexpr auto s_tag = "[HGCalRecHitsMaskPerformance]";

TEST_CASE("Standard checks of HGCalRecHitsMaskPerformance", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("HGCalRecHitsMaskPerformance"
